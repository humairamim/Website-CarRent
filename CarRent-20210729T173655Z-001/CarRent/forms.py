...
class SignUpForm(FlaskForm):
    ...
    UserType= SelectField("", validators=[InputRequired()], choices=[("tenant","tenant"),("owner","owner"),("admin","admin")])
...
class ProductForm(FlaskForm):
    ProductName = StringField("",validators=[InputRequired(), Length(min=3, max=100)], render_kw={"placeholder": "Product name"})
